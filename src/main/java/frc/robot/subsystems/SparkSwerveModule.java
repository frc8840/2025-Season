...
public class SparkSwerveModule {
  ...
  public SparkSwerveModule(int moduleNumber, SwerveModuleConstants moduleConstants) {
  ...
  private void resetToAbsolute() {
    ...
    Logger.Log(
        "angleEncoder" + angleEncoder.getDeviceID() + " canCoderDegrees: " + canAngleDegrees);
    Logger.Log(
  ...
  private void configAngleMotor() {
    ...
    angleMotor.configure(
        ...
        PersistMode.kPersistParameters); // is this correct?
    resetToAbsolute();
  }
